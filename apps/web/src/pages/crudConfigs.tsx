...
export const configs: Record<string, { title: string; path: string; fields: Field[]; columns: any[]; initial: Record<string, any> }> = {
  employees: {
    ...
    fields: [
      ...
      { name: "assignable", label: "Plaçable", type: "checkbox" }, { name: "startDate", label: "Date entrée", type: "date" }, { name: "endDate", label: "Date sortie", type: "date" },
  ...
  missions: {
    ...
    fields: [
      { name: "title", label: "Titre" }, { name: "clientId", label: "Client ID" },
  ...
  partnerResources: {
    ...
    fields: [{ name: "partnerId", label: "Partner ID" }, { name: "firstName", label: "Prénom" }, { name: "lastName", label: "Nom" }, { name: "role", label: "Rôle" }, { name: "dailyCost", label: "TJM achat", type: "number" }, { name: "monthlyFees", label: "Frais mensuels", type: "number" }, { name: "availableFrom", label: "Début dispo", type: "date" }, { name: "availableTo", label: "Fin dispo", type: "date" }],
  ...
  variableCosts: {
    ...
    fields: [{ name: "label", label: "Libellé" }, { name: "category", label: "Catégorie" }, { name: "amount", label: "Montant", type: "number" }, { name: "date", label: "Date", type: "date" }, { name: "missionId", label: "Mission ID" }, { name: "resourceId", label: "Ressource ID" }, { name: "notes", label: "Notes", type: "textarea" }],
