...
v2Router.use("/timesheets", crud("timesheet" as any));
v2Router.use("/invoices", crud("invoice" as any));
...
v2Router.use("/webhooks", crud("webhookSubscription" as any));

v2Router.get("/actuals/monthly", async (_req, res, next) => {
  try {
...
v2Router.get("/executive/situation", async (req, res, next) => {
  try {
...
v2Router.post("/actuals/monthly", async (req, res, next) => {
  try {
    const data = sanitize(coerceDates(req.body, dateFields));
...
v2Router.get("/variances/monthly", async (req, res, next) => {
  try {
...
v2Router.get("/monthly-closes", async (_req, res, next) => {
  try {
...
v2Router.post("/monthly-closes/:month/prepare", async (req, res, next) => {
  try {
...
v2Router.post("/monthly-closes/:month/close", async (req, res, next) => {
  try {
    const [year, month] = parseMonth(req.params.month);
    const company = await requireCompany();
...
v2Router.post("/monthly-closes/:month/reopen", async (req, res, next) => {
  try {
    const [year, month] = parseMonth(req.params.month);
    const company = await requireCompany();
...
v2Router.post("/timesheets/:id/submit", (req, res, next) => updateStatus(prisma.timesheet, req.params.id, { status: "submitted", submittedAt: new Date(), submittedBy: req.body.submittedBy }, res, next));
v2Router.post("/timesheets/:id/approve", (req, res, next) => updateStatus(prisma.timesheet, req.params.id, { status: "approved", approvedAt: new Date(), approvedBy: req.body.approvedBy }, res, next));
v2Router.post("/timesheets/:id/reject", (req, res, next) => updateStatus(prisma.timesheet, req.params.id, { status: "rejected" }, res, next));
v2Router.post("/timesheets/:id/lock", (req, res, next) => updateStatus(prisma.timesheet, req.params.id, { status: "locked", lockedAt: new Date() }, res, next));
v2Router.post("/timesheets/:id/generate-invoice", async (req, res, next) => {
  try {
...
v2Router.post("/invoices/:id/mark-paid", async (req, res, next) => {
  try {
...
v2Router.get("/reconciliation/billing", async (_req, res, next) => {
  try {
...
v2Router.post("/reconciliation/billing/:id/match", (req, res, next) => updateStatus(prisma.billingReconciliation, req.params.id, { status: "matched", ...req.body }, res, next));
v2Router.post("/reconciliation/billing/:id/ignore", (req, res, next) => updateStatus(prisma.billingReconciliation, req.params.id, { status: "ignored" }, res, next));

v2Router.get("/capacity", async (req, res, next) => {
  try {
...
v2Router.get("/capacity/skills", async (_req, res, next) => {
  try {
...
v2Router.get("/staffing/forecast", async (req, res, next) => {
  try {
...
v2Router.get("/risks/strategic", async (req, res, next) => {
  try {
...
v2Router.get("/risks/dependencies", async (req, res, next) => {
  try {
    res.json(await buildStrategicRisks(stringParam(req.query.scenarioId), numberParam(req.query.horizon)));
  } catch (error) {
    next(error);
...
v2Router.post("/monte-carlo/run", async (req, res, next) => {
  try {
...
v2Router.get("/monte-carlo/results/:id", async (req, res, next) => {
  try {
...
v2Router.post("/ai/analyze/month", async (req, res, next) => {
  try {
...
v2Router.post("/ai/analyze/scenario", async (req, res, next) => {
  try {
    res.json(await buildAiAnalysis(req.body.scenarioId, req.body.horizon));
  } catch (error) {
    next(error);
...
v2Router.post("/ai/chat", async (req, res, next) => {
  try {
...
v2Router.post("/ai/create-simulation-draft", async (req, res, next) => {
  try {
...
v2Router.post("/business-rules/evaluate", async (req, res, next) => {
  try {
...
v2Router.get("/connectors", async (_req, res, next) => {
  try {
...
v2Router.post("/connectors/:provider/sync", async (req, res, next) => {
  try {
...
v2Router.get("/connectors/:provider/status", async (req, res, next) => {
  try {
...
v2Router.get("/crm/opportunities", async (_req, res, next) => {
  try {
...
v2Router.post("/crm/opportunities/:id/convert-to-mission", async (req, res, next) => {
  try {
...
v2Router.get("/hr/absences", async (_req, res, next) => {
  try {
...
v2Router.post("/hr/absences", async (req, res, next) => {
  try {
...
v2Router.post("/workflows/:id/approve", (req, res, next) => updateStatus(prisma.approvalWorkflow, req.params.id, { status: "approved", approvedAt: new Date(), approvedBy: req.body.approvedBy, comment: req.body.comment }, res, next));
v2Router.post("/workflows/:id/reject", (req, res, next) => updateStatus(prisma.approvalWorkflow, req.params.id, { status: "rejected", rejectedAt: new Date(), rejectedBy: req.body.rejectedBy, comment: req.body.comment }, res, next));
v2Router.post("/notifications/:id/read", (req, res, next) => updateStatus(prisma.notification, req.params.id, { status: "read" }, res, next));
v2Router.post("/notifications/:id/dismiss", (req, res, next) => updateStatus(prisma.notification, req.params.id, { status: "dismissed" }, res, next));
v2Router.post("/offers/:id/submit-review", (req, res, next) => updateStatus(prisma.offer, req.params.id, { status: "internal_review" }, res, next));
v2Router.post("/offers/:id/approve", (req, res, next) => updateStatus(prisma.offer, req.params.id, { status: "accepted" }, res, next));
v2Router.post("/offers/:id/convert-to-mission", async (req, res, next) => {
  try {
...
v2Router.get("/public/docs", (_req, res) => {
  res.json({
...
v2Router.get("/api-keys", async (_req, res, next) => {
  try {
...
v2Router.post("/api-keys", async (req, res, next) => {
  try {
...
v2Router.delete("/api-keys/:id", async (req, res, next) => {
  try {
