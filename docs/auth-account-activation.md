...
La création d'un utilisateur envoie un email d'activation contenant un lien `#/first-login?token=...`.
...
Sans `SMTP_HOST`, l'API n'envoie pas d'email et affiche le lien d'activation dans les logs de développement.
